...
var BattleTank = function() {
	...
	var Tank = function(tankId, x, y, color, grid) {
		...
		this.showCPU = function() {
			...
			html += '</div></div>';
			html += '<div id="output" data-collapsed="true" data-role="collapsible"><h2>出力</h2><table class="device_table"><tr><th>出力デバイス:</th><th>アキュムレータ</th></tr><tr><td><select data-mini="true" name="select_output_device" id="select_output_device"><option value="0">0: ユーザ出力</option><option value="1">1: 移動</option><option value="2">2: 方向転換</option><option value="3">3: 大砲の向き</option><option value="4">4: 武器</option></select></td><td><select data-mini="true" name="select_output_accumulator" id="select_output_accumulator"><option>任意</option></select></td></tr></table><div id="output_explanation">ユーザに値を送る</div><a id="btn_current_output_value" data-iconpos="right" data-inline="true" data-mini="true" data-icon="refresh">テスト</a>例:<textarea id="output_code_sample" class="code_sample">OUT 0 // display a number</textarea></div>';
