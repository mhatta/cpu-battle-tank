...
var BattleTank = function() {
	...
	var Tank = function(tankId, x, y, color, grid) {
		...
		this.showCPU = function() {
			...
			html +='<tr><td><select data-mini="true" name="select_input_device" id="select_input_device"><option value="0">0: ユーザ入力</option><option value="1">1: ナビゲーションシステム</option><option value="2">2: 衝突レーダー</option><option value="3">3: 備蓄</option></select></td><td><select data-mini="true" name="select_input_accumulator" id="select_input_accumulator"><option>Any</option></select></td></tr></table><div id="input_explanation">Read value from the user</div>'
